...
wget https://download.samba.org/pub/samba/stable/samba-4.9.16.tar.gz
#wget https://download.samba.org/pub/samba/stable/samba-4.10.10.tar.gz
...
read -p "Press [Enter] key to add timemachine share samba..."
